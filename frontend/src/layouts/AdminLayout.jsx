        ...
        <div className="flex min-h-screen bg-slate-50 text-slate-800">
            <aside className="w-20 lg:w-64 bg-indigo-800 text-indigo-100 flex flex-col fixed h-full z-20 transition-all duration-300">
                <div className="p-6 flex items-center gap-3 mb-6 bg-indigo-950/30">
                    <span className="font-bold text-xl text-white hidden lg:block tracking-tight">Admin</span>
                </div>
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) => 
                                `w-full flex items-center gap-4 p-3 rounded-lg transition-colors ${
                                    isActive
                                    ? 'bg-indigo-950 text-white shadow-md' // Style quand on est sur la page (Actif)
                                    : 'text-indigo-100 hover:bg-indigo-800/50 hover:text-white' // Style par défaut
                                }`
                            }
                        >
                            <span>{item.icon}</span>
